    ...
    <MainLayout name={"User: " + userData.firstname + ' ' + userData.lastname}>
      <div className="box">
        <div className='box-left'>
          ...
          <VereficationUserProfileInfo user={userData} onEdit={updateUserData}>
          </VereficationUserProfileInfo>
          <VereficationUserVerefication verUser={verUser} user={user.verStatus}>
          </VereficationUserVerefication>
        </div> 
        <div className="box-right">
          <VereficationVideo videoUrl={verUser.videoUrl} videoDate={verUser.videoDate}></VereficationVideo>
