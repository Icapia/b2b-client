...
export const ChargingSiteEditForm: FC<ChargingSiteEditFormI> = ({ organizations }) => {
  ...
  const handlerChangeCoordinates = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const coordinates: Location = {
      ...
      coordinates: [
        ...
        !isLongitude ? event.target.valueAsNumber : form.location.coordinates[1],
      ],
    };
        ...
        >
          ...
          >
            <FormControl
              ...
              className='mt-20'
            >
              <InputLabel htmlFor='default_price'>Coordinates (Longitude)</InputLabel>
              <OutlinedInput
          ...
          >
            <FormControl
              ...
              className='mt-20'
            >
              <InputLabel htmlFor='default_price'>Coordinates (Latitude)</InputLabel>
              <OutlinedInput
