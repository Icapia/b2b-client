  ...
  return (
    <div className={isActive ? "sidebar sidebar__active" : 'sidebar'}>
        <div className="sidebar__wrapper">
          <Link href={'/dashboard'}>
            { isActive ? <a><LogoM className="sidebar__logo"></LogoM></a> : <a><Logo className="sidebar__logo"></Logo></a>}
          </Link>
          <SidebarUserInfo state={isActive}></SidebarUserInfo>
          <SidebarNavMenu state={isActive}></SidebarNavMenu>
          
          <div id="sibebar__toggle" className="sibebar__toggle" onClick={toggleSidebar}>
